...
export default class VideoPlayer extends Component {
    ...
    */
    ...
    _onScreenTouch() {
        ...
        console.log("on screeen toood", delta)
        if (delta < 300) {
    ...
    */
    ...
    hideControlAnimation() {
        Animated.parallel([
            Animated.timing(
                ...
                { toValue: 0, useNativeDriver: Platform.OS === 'android' }
            ),
            Animated.timing(
                this.animations.topControl.marginTop,
                { toValue: -100, useNativeDriver: Platform.OS === 'android' }
            ),
            Animated.timing(
    ...
    showControlAnimation() {
        Animated.parallel([
            Animated.timing(
                this.animations.topControl.opacity,
                { toValue: 1, useNativeDriver: Platform.OS === 'android' }
            ),
            Animated.timing(
                this.animations.topControl.marginTop,
                { toValue: 0, useNativeDriver: Platform.OS === 'android' }
    ...
    _toggleControls() {
        ...
        console.log("_toggleControls", state.showControls);
        if (state.showControls) {
